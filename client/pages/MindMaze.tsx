  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950 to-slate-950">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-40 right-10 w-72 h-72 bg-blue-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse-glow"></div>
      </div>
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold text-white mb-4">🧩 MindMaze</h1>
          <p className="text-xl text-gray-300">
            Solve collaborative puzzles and enigmas with your friends
          </p>
        </div>
        ...
        {gameMode === "lobby" ? (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-2xl mx-auto">
            ...
            <div className="glass-effect rounded-2xl p-8 border border-white/20 hover:border-white/40 transition-all">
              <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-purple-600 to-blue-600 flex items-center justify-center mb-6 mx-auto">
            ...
            <div className="glass-effect rounded-2xl p-8 border border-white/20 hover:border-white/40 transition-all">
              ...
              <input
                ...
                className="w-full px-4 py-2 rounded-lg bg-white/10 border border-white/20 text-white placeholder-gray-500 mb-3 focus:outline-none focus:border-purple-500/50"
              />
              <input
                type="text"
                placeholder="Your username"
